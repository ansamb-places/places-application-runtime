  ...
  Foundation.libs.dropdown = {
    ...
    events : function (scope) {
      ...
      S(this.scope)
        ...
        .on('click.fndtn.dropdown', function (e) {
          ...
          if (S(e.target).data(self.data_attr()) || S(e.target).parent().data(self.data_attr()) || S(e.target).data("no-dropdown-close")) {
            return;
          }
    ...
    dirs : {
      ...
      custom: function(t, s) {
        ...
        if(s.hasOwnProperty("correct_left") && typeof s.correct_left == "number"){
          p.left -= s.correct_left;
          pip_offset_base += s.correct_left;
        }
        if(s.hasOwnProperty("correct_top") && typeof s.correct_top == "number"){
          p.top += s.correct_top;
        }
