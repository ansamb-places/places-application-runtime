...
define [
	'cs!./FileView',
	'text!template/audio.tmpl',
	'text!template/paudio.tmpl',
	'cs!js/pluginLoader'
	...
	class ItemView extends FileView
		...
		onRender:(e)->
			super()
			if @type == 'popup' and navigator.plugins["Shockwave Flash"]
				force= false
				force = true if @model.get('data.mime_type') == 'audio/mp3'
				setTimeout ()=>
